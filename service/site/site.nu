...
(get "/delete/phrase_id:"
     ...
     (set phrase_id ((REQUEST bindings) phrase_id:))
     (mongo removeWithCondition:(dict destination_id:(oid phrase_id)) fromCollection:"telephone.translations")
     (mongo removeWithCondition:(dict source_id:(oid phrase_id)) fromCollection:"telephone.translations")
